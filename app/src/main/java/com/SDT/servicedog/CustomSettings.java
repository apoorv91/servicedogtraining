...
public class CustomSettings extends ArrayAdapter<String> {
    ...
    public CustomSettings(Activity context, ArrayList<String> listTasks) {
        super(context, R.layout.settings_content_main, listTasks);
